...
const TENANT_MIGRATION_FILES: { version: number; file: string }[] = [
  ...
  { version: 174, file: '174_entity_settings_recon_immaterial_waiver.sql' },
  { version: 175, file: '175_bank_transactions.sql' },
  { version: 176, file: '176_gate_events_and_auto_advance.sql' },
  { version: 177, file: '177_oauth_tokens.sql' },
  { version: 178, file: '178_auto_match_rules_and_tasks.sql' },
  { version: 179, file: '179_recon_supporting_source_constraint.sql' },
  { version: 180, file: '180_close_sessions_advanced_by.sql' },
  { version: 181, file: '181_evidence_retention_triggers.sql' },
  { version: 182, file: '182_subsequent_events_review.sql' },
  { version: 183, file: '183_bai2_source_format.sql' },
  { version: 184, file: '184_row_level_security.sql' },
  { version: 185, file: '185_cascade_performance_indexes.sql' },
  { version: 186, file: '186_audit_fk_indexes.sql' },
