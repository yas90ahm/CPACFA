...
/** Allowed roles for registration (matches CloseRole + accountant). */
const ALLOWED_ROLES = ['accountant', 'preparer', 'reviewer', 'approver'] as const;
...
/** Register (for dev/setup): create tenant + user. Requires DATABASE_URL. */
