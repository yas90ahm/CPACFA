...
INSERT INTO erp_mapping_profiles (id, tenant_id, connection_id, provider, profile_name, data_type, is_template, is_active)
VALUES ('tmpl-qb-tb', '__system__', '__template__', 'quickbooks', 'QuickBooks Standard', 'trial_balance', TRUE, TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO erp_mapping_rules (profile_id, source_field, canonical_field, transform_type, transform_config, is_required, sort_order) VALUES
