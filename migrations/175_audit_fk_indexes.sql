...
DO $$ BEGIN
  ALTER TABLE pe_hierarchy
    ADD CONSTRAINT fk_pe_hierarchy_parent
    FOREIGN KEY (parent_pe_line_id) REFERENCES pe_hierarchy(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
CREATE INDEX IF NOT EXISTS idx_pe_hierarchy_parent ON pe_hierarchy(parent_pe_line_id);

-- Recon Source Data: FK to reconciliations
DO $$ BEGIN
  ALTER TABLE recon_source_data
